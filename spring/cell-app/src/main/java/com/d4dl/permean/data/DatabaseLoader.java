...
import com.d4dl.permean.mesh.MeshLoader;
 ...
 */
@Component
public class DatabaseLoader implements CommandLineRunner, MeshLoader {
    ...
    private StatementWriter getFileWriter() {
        ...
        if(writer == null) {
            writer = new StatementWriter(this.parentSize, OFFLINE, WRITE_FILES, "localhost", "3306","plm", "root", null, 125);
